    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            ?>
                ...
                <p class="lead">
                <h3>Todas as publicações de <?php echo $post_author; ?></h3>
                </p>
            ...
            if (isset($_POST['create_comment'])) {
                ...
                if (!empty($comment_author) && !empty($comment_email) && !empty($comment_content)) {
                    // o meu nome em unapproved pode ser diferente do correto, pois estou colocando rejeitado no código
                    ...
                    if (!$create_comment_query) {
                        die("Erro na query" . mysqli_error($connection));
                    }
